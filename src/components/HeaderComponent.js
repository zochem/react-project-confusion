...
import {Navbar, NavbarBrand, Nav, NavbarToggler, Collapse, NavItem, Jumbotron, Input, Form, FormGroup, Button,Modal, ModalHeader, ModalBody, Label} from 'reactstrap';
                ...
                <div className="container">
                    ...
                    <Collapse isOpen={this.state.isNavOpen} navbar>
                        <Nav navbar>
                            ...
                            <NavItem>
                                <NavLink className="nav-link" to="/contactus"> <span className="fa fa-address fa-lg"></span> Contact</NavLink>
                            </NavItem>
                        </Nav>
